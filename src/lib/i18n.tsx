...
const dict = {
  fa: {
    ...
    pl_per_month: "در ماه",
    pl_billed_annual: "۱۲ ماه یکجا",
    pl_today: "پرداخت امروز",
    pl_subscribe: "شروع اشتراک",
    pl_switch: "تغییر به این پلن",
    pl_entry_group: "پلن‌های ورودی",
    pl_main_group: "پلن‌های اصلی",
    pl_expiry_note: "سکه‌های هر ماه تا پایان همان ماه معتبرند و به ماه بعد منتقل نمی‌شوند.",
    pl_cancel_note: "تمدید خودکار هر ماه · هر زمان می‌توانی لغو کنی.",
    // profile
    p_title: "پروفایل",
  ...
  en: {
    ...
    pl_this_month: "This month's coins",
    pl_renews: "Renews",
    ...
    pl_billed_annual: "12 months upfront",
    pl_today: "Charged today",
    pl_subscribe: "Subscribe",
    pl_switch: "Switch to this plan",
    pl_entry_group: "Entry plans",
    pl_main_group: "Main plans",
    pl_expiry_note: "Each month's coins are valid until the end of that month and do not roll over.",
    pl_cancel_note: "Renews automatically each month · cancel any time.",
    p_title: "Profile",
    p_guest: "Guest user",
    p_made: "Created",
    p_favs: "Favorites",
