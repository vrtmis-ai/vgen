/* ---------------------------------------------------------------------------
   ...
   The server is the authority on both: this is what lets the form refuse an
   empty box and a stray word before making a request, and lets it say which
   kind it thinks it has. Anything that looks plausible is sent as typed.
   --------------------------------------------------------------------------- */
