...
export const COMMUNITY: CommunityPost[] = [
  {
    id: "c1",
    ownerUserId: "u-101",
    sourceGenerationId: "g-c1",
    category: "video",
    status: "approved",
    consentAt: T - 12 * DAY,
    familyId: "seedance",
    prompt: "A lone astronaut drifting past a neon space station, slow cinematic dolly",
    seed: "vgen-astro",
    w: 16,
    h: 9,
    author: "reza.vfx",
  ...
  },
  {
    id: "c2",
    ownerUserId: "u-102",
    sourceGenerationId: "g-c2",
    category: "image",
    status: "approved",
    consentAt: T - 11 * DAY,
    familyId: "nano-banana",
    prompt: "Hyperreal portrait of an elderly Persian calligrapher, warm window light",
    seed: "vgen-calli",
    w: 3,
    h: 4,
    author: "atelier.sahar",
    likes: 2061,
  },
  {
    id: "c3",
    ownerUserId: "u-103",
    sourceGenerationId: "g-c3",
    category: "image",
    status: "approved",
    consentAt: T - 10 * DAY,
    familyId: "ideogram",
    prompt: "Bold typographic poster reading TEHRAN, bauhaus grid, crimson and ink",
    seed: "vgen-poster",
    w: 3,
    h: 4,
    author: "pixel_arman",
  ...
  },
  {
    id: "c4",
    ownerUserId: "u-104",
    sourceGenerationId: "g-c4",
    category: "image",
    status: "approved",
    consentAt: T - 9 * DAY,
    familyId: "seedream",
    prompt: "Cyberpunk night market in the rain, reflective neon puddles, shallow depth",
    seed: "vgen-cyber",
    w: 16,
    h: 9,
    author: "neon.kourosh",
  ...
  },
  {
    id: "c5",
    ownerUserId: "u-105",
    sourceGenerationId: "g-c5",
    category: "video",
    status: "approved",
    consentAt: T - 8 * DAY,
    familyId: "kling",
    prompt: "A paper boat racing down a rushing gutter after rain, macro, soft focus",
    seed: "vgen-boat",
    w: 9,
    h: 16,
    author: "baran.render",
  ...
  },
  {
    id: "c6",
    ownerUserId: "u-106",
    sourceGenerationId: "g-c6",
    category: "image",
    status: "approved",
    consentAt: T - 7 * DAY,
    familyId: "gpt-image",
    prompt: "Isometric tiny cozy bookstore on a rainy corner, pastel palette, detailed",
    seed: "vgen-shop",
    w: 1,
    h: 1,
    author: "studio_aaye",
  ...
  },
  {
    id: "c7",
    ownerUserId: "u-107",
    sourceGenerationId: "g-c7",
    category: "image",
    status: "approved",
    consentAt: T - 6 * DAY,
    familyId: "flux",
    prompt: "Dramatic basalt coastline at golden hour, volumetric light, long exposure",
    seed: "vgen-coast",
    w: 16,
    h: 9,
    author: "kavé.studio",
  ...
  },
  {
    id: "c8",
    ownerUserId: "u-108",
    sourceGenerationId: "g-c8",
    category: "image",
    status: "approved",
    consentAt: T - 5 * DAY,
    familyId: "qwen",
    prompt: "Loose watercolor fox curled in an autumn forest, paper grain",
    seed: "vgen-fox",
    w: 1,
    h: 1,
    author: "niloo.creates",
    likes: 1183,
  },
  {
    id: "c9",
    ownerUserId: "u-109",
    sourceGenerationId: "g-c9",
    category: "image",
    status: "approved",
    consentAt: T - 4 * DAY,
    familyId: "imagen",
    prompt: "Studio shot of a faceted glass perfume bottle on a silk gradient",
    seed: "vgen-perfume",
    w: 1,
    h: 1,
    author: "darkroom.h",
  ...
  // no single job behind it and no recreate.
  {
    ...
    consentAt: T - 3 * DAY,
    familyId: "veo",
    prompt: "Timelapse of desert flowers blooming at dawn, vivid, shallow focus",
    seed: "vgen-bloom",
    w: 9,
    h: 16,
    author: "mahsa.makes",
