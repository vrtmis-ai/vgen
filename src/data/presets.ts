...
export const PRESETS: Preset[] = [
  row(
    ...
    "video",
    "camera",
    "extreme continuous zoom out from a close-up, pulling back through the atmosphere until the whole planet fills frame, seamless, cinematic, of ",
    "پرطرفدار",
  ),
  row(
    "p2",
  ...
  row(
    ...
    "image",
    "portrait",
    "cinematic portrait, dramatic rim lighting, 85mm, shallow depth of field, film grain, ultra detailed, of ",
    "پرطرفدار",
  ),
  row(
    "p10",
